...
// Sarrafiye'de gösterilmeyecek editable satırlar (Kuyumcu Paneli readonly
// referansları zaten "READONLY" kategorisinde, otomatik dışarıda). Has Altın
// ham referansı editable kalmışsa diye savunma amaçlı eleniyor.
...
export function MobileApp() {
  ...
  // Native kurulum: status bar (beyaz ikon + overlay) + splash gizle + geri tuşu.
  useEffect(() => {
    ...
    (async () => {
      ...
      // Android geri tuşu: kök sekmedeyse çık, değilse Sarrafiye'ye dön.
  ...
  return (
    <div className="flex flex-col h-[100dvh] bg-gray-50">
      {/* Marka başlığı — gold, status bar altına uzanır (beyaz ikon). Menü YOK. */}
      <header
      ...
      {/* İçerik — scroll'u her sekme kendi içinde yönetir */}
